...
musica_de_fundo = pygame.mixer.music.load('Atack Space/jogo/sounds/music_batlle.mp3') #carrega música de fundo 

som_disparo = pygame.mixer.Sound('Atack Space/jogo/sounds/Disparo_laser.wav') #função que recebe o som de disparo
som_colisão_inimigo = pygame.mixer.Sound('Atack Space/jogo/sounds/Explosão_1.wav') #função que recebe o som de disparo colidindo com inimigos
som_dano = pygame.mixer.Sound('Atack Space/jogo/sounds/Som_de_dano_1.wav') #função que recebe o som dos inimigos colidindo com a nave
som_perda = pygame.mixer.Sound('Atack Space/jogo/sounds/você_perdeu.wav')
...
imagem_de_fundo_inicial = pygame.image.load('Atack Space/jogo/background/Tela_inicial/tela inicial.png').convert() #carrega a imagem de fundo da tela de start
imagem_de_fundo_inicial_start = pygame.image.load('Atack Space/jogo/background/Tela_inicial/tela inicial start.png').convert() #carrega a imagem de fundo da tela de start mas com a menssagem de iniciar aparecendo
imagem_de_fundo_gameplay = pygame.image.load('Atack Space/jogo/background/Espaço.png').convert() #carrega a imagem de fundo do jogo iniciado
imagem_game_over = pygame.image.load('Atack Space/jogo/game over/Game over.png')  

barra_de_informacoes = pygame.image.load('Atack Space/jogo/Barra com vida/barra_de_informações.png')
ponto_de_vida_nave = pygame.image.load('Atack Space/jogo/Barra com vida/vida_nave.png') 
ponto_de_vida_terra = pygame.image.load('Atack Space/jogo/Barra com vida/vida_terra.png')

lista_disparo = ['Atack Space/jogo/Disparo/Disparo0.png', 'Atack Space/jogo/Disparo/Disparo1.png', 'Atack Space/jogo/Disparo/Disparo2.png', 'Atack Space/jogo/Disparo/Disparo3.png']
lista_alienigena = ['Atack Space/jogo/Alienígena/Alienígena0.png', 'Atack Space/jogo/Alienígena/Alienígena1.png', 'Atack Space/jogo/Alienígena/Alienígena2.png', 'Atack Space/jogo/Alienígena/Alienígena3.png']
lista_meteoro = ['Atack Space/jogo/Meteoro_j/sprite_0.png', 'Atack Space/jogo/Meteoro_j/sprite_1.png', 'Atack Space/jogo/Meteoro_j/sprite_2.png', 'Atack Space/jogo/Meteoro_j/sprite_3.png']
lista_explosao = ['Atack Space/jogo/Explosão/explosão0.png','Atack Space/jogo/Explosão/explosão1.png','Atack Space/jogo/Explosão/explosão2.png','Atack Space/jogo/Explosão/explosão3.png']
...
class Nave(pygame.sprite.Sprite): #A classe 'nave' vai herdar outra classe do pygame, a 'sprite'
    def __init__(self):
        ...
        self.sprites.append(pygame.image.load('Atack Space/jogo/NAVE/sprite_nave0.png')) #appenda as sprites na lista com a função 'load', o primeiro parâmetro é a pasta que contém as imagens e o segundo parâmetro é o nome da imagem
        self.sprites.append(pygame.image.load('Atack Space/jogo/NAVE/sprite_nave1.png'))
        self.sprites.append(pygame.image.load('Atack Space/jogo/NAVE/sprite_nave2.png'))
        self.sprites.append(pygame.image.load('Atack Space/jogo/NAVE/sprite_nave3.png'))
        self.atual = 0
